...
This package provides terminal utilities for the llm-water-tracker toolchain.

## Package Overview

**Name**: `@llm-water-tracker/terminal`
**Description**: Terminal utilities for llm-water-tracker
...
This package contains terminal utilities used across the llm-water-tracker monorepo:
...
Follow the same code style guidelines as the main llm-water-tracker package:
