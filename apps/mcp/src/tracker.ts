...
export const trackerParametersShape = {
...
export const trackerParametersSchema = z.object(trackerParametersShape);
...
function getCcusageInvocation(): CliInvocation {
	...
	const entryPath = resolveBinaryPath('llm-water-tracker', 'llm-water-tracker');
...
async function runCcusageCliJson(
	...
	parameters: z.infer<typeof trackerParametersSchema>,
	claudePath: string,
): Promise<string> {
	...
	return executeCliCommand(executable, cliArgs, {
		// Set Claude path for llm-water-tracker
