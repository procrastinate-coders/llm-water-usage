 ...
 * ```typescript
 * // Basic cleanup
 * parseProjectName('-Users-phaedrus-Development-llm-water-tracker')
 * // → 'llm-water-tracker'
 *
 ...
 * ```typescript
 * // Without aliases
 * formatProjectName('-Users-phaedrus-Development-llm-water-tracker')
 * // → 'llm-water-tracker'
 *
 * // With alias
 * const aliases = new Map([['llm-water-tracker', 'Usage Tracker']]);
 * formatProjectName('-Users-phaedrus-Development-llm-water-tracker', aliases)
 * // → 'Usage Tracker'
 * ```
 */
	...
	describe('project name formatting', () => {
		describe('parseProjectName', () => {
			...
			it('extracts project names from Unix-style paths', () => {
				expect(formatProjectName('-Users-phaedrus-Development-llm-water-tracker')).toBe('llm-water-tracker');
				expect(formatProjectName('/Users/phaedrus/Development/llm-water-tracker')).toBe('llm-water-tracker');
			});
		...
		describe('custom aliases', () => {
			it('uses configured aliases', () => {
				const aliases = new Map([
					['llm-water-tracker', 'Usage Tracker'],
					['test', 'Test Project'],
				]);

				expect(formatProjectName('llm-water-tracker', aliases)).toBe('Usage Tracker');
			...
			it('applies aliases to parsed project names', () => {
				...
				expect(formatProjectName('-Users-phaedrus-Development-llm-water-tracker', aliases)).toBe(
					'Usage Tracker',
				);
			});
