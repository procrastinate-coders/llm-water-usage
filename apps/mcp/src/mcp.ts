 ...
 *
 * This module provides MCP server functionality for exposing llm-water-tracker data
...
import {
	trackerParametersSchema,
	trackerParametersShape,
	getCcusageBlocks,
	getCcusageDaily,
	getCcusageMonthly,
	getCcusageSession,
...
export function createMcpServer(options?: LoadOptions): McpServer {
	...
	server.registerTool(
		'daily',
		{
			...
			inputSchema: trackerParametersShape,
		},
		async (args) => {
			const parameters = trackerParametersSchema.parse(args);
